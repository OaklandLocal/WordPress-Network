...
if( isset($oxy_theme) ) {
    ...
    $oxy_theme->register_option_page( array(
        'page_title' => THEME_NAME . ' - ' . __('Theme Permalinks', 'swatch-admin-td'),
        'menu_title' => __('Permalinks', 'swatch-admin-td'),
    ...
    $oxy_theme->register_option_page( array(
        ...
        'sections'   => array(
            'css-section' => array(
                ...
                'header'  => __('Here you can save some custom CSS that will be loaded in the header.  This will allow you to override some of the default styling of the theme.', 'swatch-admin-td'),
                'fields' => array(
                    array(
...
$oxy_theme->register_option_page( array(
    ...
    'sections'   => array(
        'facebook-section' => array(
            'title'   => __('Facebook Like', 'swatch-admin-td'),
            'header'  => __('Set the style of facebook like button', 'swatch-admin-td'),
            'fields' => array(
                array(
                    'name'    => __('Show Like Button', 'swatch-admin-td'),
                    'desc'    => __('Show facebook like button on your single blog pages', 'swatch-admin-td'),
                    'id'      => 'fb_show',
                    'type'    => 'radio',
                    'options' => array(
                        'show' => __('Show', 'swatch-admin-td'),
        ...
        'twitter-section' => array(
            ...
            'header'  => __('Set the style of twitter tweet button', 'swatch-admin-td'),
            'fields' => array(
                array(
                    'name'    => __('Show Tweet Button', 'swatch-admin-td'),
                    'desc'    => __('Show tweet like button on your single blog pages', 'swatch-admin-td'),
                    'id'      => 'twitter_show',
                    'type'    => 'radio',
                    'options' => array(
                        'show' => __('Show', 'swatch-admin-td'),
        ...
        'google-section' => array(
            ...
            'header'  => __('Set the style of your google plus button', 'swatch-admin-td'),
            'fields' => array(
                array(
