...
function my_theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'slug'                  => 'revslider',
            'source'                => get_stylesheet_directory() . '/inc/modules/tgm-plugin/plugins/revslider.zip',
            'required'              => false,
            'version'               => '3.0.95',
            'force_activation'      => false,
            'force_deactivation'    => false,
        ...
        array(
            'name'                  => 'Oxygenna Theme Framework',
            'slug'                  => 'oxygenna-theme',
            'source'                => get_stylesheet_directory() . '/inc/modules/tgm-plugin/plugins/oxygenna-theme.zip',
            'required'              => true,
            'version'               => '1.1.2',
        ...
        array(
            'name'                  => 'Oxygenna Bootstrap Plugin',
            'slug'                  => 'oxygenna-boots',
            'source'                => get_stylesheet_directory() . '/inc/modules/tgm-plugin/plugins/oxygenna-boots.zip',
            'required'              => true,
            'version'               => '1.0.1',
            'force_activation'      => true,
            'force_deactivation'    => true,
        ...
        array(
            'name'                  => 'Oxygenna Typography Plugin',
            'slug'                  => 'oxygenna-type',
            'source'                => get_stylesheet_directory() . '/inc/modules/tgm-plugin/plugins/oxygenna-type.zip',
            'required'              => true,
            'version'               => '1.0.2',
            'force_activation'      => true,
            'force_deactivation'    => true,
