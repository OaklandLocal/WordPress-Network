...
add_action('do_meta_boxes', 'oxy_move_slideshow_meta_box');
 ...
 function fetch_custom_columns($column) {
    global $post;
    switch( $column ) {
        case 'menu_order':
...
add_action( 'manage_posts_custom_column', 'fetch_custom_columns' );
...
$args = array(
    ...
    'hierarchical'       => false,
    'menu_position'      => null,
    'menu_icon'          => OXY_FRAMEWORK_URI . 'images/services.png',
    'supports'           => array( 'title', 'editor', 'thumbnail', 'page-attributes' ),
...
$args = array(
    ...
    'hierarchical'       => false,
    'menu_position'      => null,
    'menu_icon'          => OXY_FRAMEWORK_URI . 'images/testimonials.png',
    'supports'           => array( 'title', 'editor', 'thumbnail', 'page-attributes' )
);
...
$args = array(
    ...
    'hierarchical'       => false,
    'menu_position'      => null,
    'menu_icon'          => OXY_FRAMEWORK_URI . 'images/staff.png',
    'supports'           => array( 'title', 'editor', 'thumbnail', 'page-attributes' ),
...
$args = array(
    ...
    'hierarchical'       => false,
    'menu_position'      => null,
    'menu_icon'          => OXY_FRAMEWORK_URI . 'images/portfolio.png',
...
$args = array(
    ...
    'hierarchical'       => false,
    'menu_position'      => null,
    'menu_icon'          => OXY_FRAMEWORK_URI . 'images/swatch.png',
