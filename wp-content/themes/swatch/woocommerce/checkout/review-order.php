...
<div id="order_review">
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters('woocommerce_order_button_html', '<input type="submit" class="btn btn-primary fullwidth btn-large" name="woocommerce_checkout_place_order" id="place_order" value="' . $order_button_text . '" />' );
			?>
