...
<div class="row">
    ...
    <div class="span6">
    	...
    	<form method="post" class="login">
			<label class="control-label" for="username"><?php _e( 'Username or email', 'woocommerce' ); ?> <span class="required">*</span></label>
            <input type="text" class="input-text" name="username" id="username" />
    		<label class="control-label" for="password"><?php _e( 'Password', 'woocommerce' ); ?> <span class="required">*</span></label>
    	...
    	<div class="span6">
    		...
    		<form method="post" class="register">
    			...
    			<?php if ( get_option( 'woocommerce_registration_email_for_username' ) == 'no' ) : ?>
					...
					<label class="control-label" for="reg_username"><?php _e( 'Username', 'woocommerce' ); ?> <span class="required">*</span></label>
